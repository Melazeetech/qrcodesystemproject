        ...
        <div className="p-6 space-y-6">
          ...
          <section className="bg-green-50 border border-green-200 rounded-lg p-4">
            <h3 className="text-lg font-semibold text-green-900 mb-3 flex items-center">
              ...
              Quick Setup for Demo (Camera Issues Fixed!)
            </h3>
            <div className="bg-blue-50 border border-blue-200 rounded p-3 mb-3">
              <h4 className="font-semibold text-blue-900 mb-1">Camera Not Working?</h4>
              <p className="text-sm text-blue-800">
                The system now has improved camera handling and manual input fallback. 
                If camera fails, students can use "Manual Input" option.
              </p>
            </div>
              ...
              <div className="flex items-start space-x-3 p-4 bg-green-50 rounded-lg">
                ...
                <div>
                  ...
                  <ul className="text-green-800 text-sm space-y-1 mt-1">
                    ...
                    <li>• Point camera at laptop screen OR use manual input</li>
                  </ul>
                </div>
              </div>
          ...
          <section>
            ...
            <div className="space-y-3">
              ...
              <div className="border border-gray-200 rounded-lg p-3">
                ...
                <ul className="text-sm text-gray-600 mt-1 space-y-1">
                  <li>• ✅ System now auto-detects camera issues</li>
                  <li>• ✅ Manual input option always available</li>
                  <li>• ✅ Better error messages and fallbacks</li>
                  <li>• Students can copy QR code data from lecturer's screen</li>
                </ul>
              </div>
            </div>
          </section>
